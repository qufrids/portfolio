...
export function Contact() {
  return (
    <section id="contact" className="py-24 px-6 bg-border-subtle">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
          ...
          {siteConfig.social.linkedin && (
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-6 py-3 border border-border font-medium rounded-full hover:bg-background transition-colors"
            >
